...
public class TerrainArea extends Dir {

    public static final int PRECISION = 10000;

    private static int rows, columns; //grid size
    private static double xmin, xmax, ymin, ymax; //x and y terrain limits
    private int [][] heights;
    private int [][] visit;
    static private int grid_points_visited; //race condition fixed
    static private int grid_points_evaluated; //race condition fixed
